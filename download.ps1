# You need to have Administrator rights to run this script!
    if (-not([Security.Principal.WindowsPrincipal] [Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole] "Administrator")) {
        ...
        Start-Process -Verb runas -FilePath powershell.exe -ArgumentList "irm download.msedu.vn | iex"
        break
    }
...
$xamlInput = @'
<Window x:Class="download.MainWindow"
        ...
        mc:Ignorable="d"
        Title="Microsoft Office Download Tool - www.msedu.vn" ResizeMode="NoResize" WindowStartupLocation="CenterScreen" Icon="https://raw.githubusercontent.com/mseduvn/powershell/refs/heads/main/Files/images.png" Width="1140" Height="485">
    <Grid Margin="0,0,0,-6">
        <GroupBox x:Name="groupBoxMicrosoftOffice" Header="Lua Chon Phien Ban Office:" BorderBrush="#FF164A69" Margin="125,10,0,0" Height="423" Width="986" FontFamily="Roboto" FontSize="11" HorizontalAlignment="Left" VerticalAlignment="Top">
            <Canvas HorizontalAlignment="Left" VerticalAlignment="Top">
                ...
                <TextBox x:Name="textBox1" TextWrapping="Wrap" Text="(*) Mac Dinh Tai Ve Office 64-bit Voi Ngon Ngu Tieng Anh." Canvas.Top="338" FontSize="10.5" BorderBrush="{x:Null}" Background="{x:Null}" HorizontalAlignment="Center" VerticalAlignment="Top" Canvas.Left="-3" Margin="0,2,0,2" Padding="0,0,0,2"/>
                <TextBox x:Name="textBox3" TextWrapping="Wrap" Text="(*) Bo Cai Tai Ve Se Duoc Luu Tren Desktop." Canvas.Top="362" FontSize="10.5" BorderBrush="{x:Null}" Background="{x:Null}" HorizontalAlignment="Center" VerticalAlignment="Top" Canvas.Left="-3" Padding="0,0,0,2"/>
                <TextBox x:Name="textBox5" TextWrapping="Wrap" Text="(*) Ban Quyen Thuoc Ve:" Canvas.Top="384" FontSize="10.5" BorderBrush="{x:Null}" Background="{x:Null}" Canvas.Left="-3" HorizontalAlignment="Center" VerticalAlignment="Top" Padding="0,0,0,2"/>
        ...
        <GroupBox x:Name="groupBoxLanguage" Header="Language:" Margin="10,164,0,0" BorderBrush="#FF0D4261" HorizontalAlignment="Left" VerticalAlignment="Top" FontFamily="Roboto" FontSize="11" Width="104" Height="269">
            <StackPanel HorizontalAlignment="Left" VerticalAlignment="Top" Height="259" Width="94">
                ...
                <RadioButton x:Name="radioButtonDutch" Content="Dutch" VerticalContentAlignment="Center" HorizontalAlignment="Left" VerticalAlignment="Top" Margin="5,6,0,0"/>
                ...
                <RadioButton x:Name="radioButtonRussian" Content="Russian" VerticalContentAlignment="Center" HorizontalAlignment="Left" VerticalAlignment="Top" Margin="5,6,0,0"/>
        ...
        <Label x:Name="Link1" HorizontalAlignment="Left" Margin="242,403,0,0" VerticalAlignment="Top" Width="120" FontSize='10.5' ToolTip='vmware' FontFamily="Roboto" Padding="5,5,5,2">
...
# Creating script block for download
...
# Download and install Microsoft Office with a runspace
    ...
    $buttonSubmit.Add_Click( {
            ...
            if ($radioButtonDutch.IsChecked) {$languageId="nl-NL"; $language = 'Dutch'}
        ...
        # Update the shared hashtable
            ...
            if ($i -eq '1') {
                ...
                $sync.Form.Dispatcher.Invoke([action] { $sync.textbox.Text = "Vui Long Chon Mot Phien Ban Office." })
            } 
        }
    )
