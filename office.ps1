    ...
    <Grid Margin="0,0,0,-6">
        <GroupBox x:Name="groupBoxMicrosoftOffice" Header="Lua chon mot uong dung:" BorderBrush="#FF164A69" Margin="125,10,0,0" Height="444" Width="986" FontFamily="Roboto" FontSize="11" HorizontalAlignment="Left" VerticalAlignment="Top">
            <Canvas HorizontalAlignment="Left" VerticalAlignment="Top">
                ...
                <Rectangle x:Name="RemoveAll" Stroke="#FFDC281F" UseLayoutRounding="True" RadiusX="5" RadiusY="5" Height="50" Width="316" Canvas.Top="343" Canvas.Left="600" HorizontalAlignment="Center" VerticalAlignment="Top"/>
                <RadioButton x:Name="radioButtonRemoveAllApp" Content="Toi dong y" FontFamily="Roboto" FontSize="11" VerticalContentAlignment="Center" IsChecked="False" Canvas.Left="613" Canvas.Top="362" HorizontalAlignment="Center" VerticalAlignment="Top"/>
                ...
                <Label x:Name="LabelRemoveAll" Content="Go bo toan bo ung dung:" FontWeight="Bold" Canvas.Left="612" Canvas.Top="330" HorizontalAlignment="Center" VerticalAlignment="Top" Background="White"/>
                <Button x:Name="buttonRemoveAll" Content="Xoa cai dat" Background="#FFE23B15" FontFamily="Roboto" FontSize="10" Foreground="White" Height="27" Width="73" UseLayoutRounding="True" BorderBrush="{x:Null}" HorizontalAlignment="Center" Canvas.Left="780" Canvas.Top="376" VerticalAlignment="Top"/>
                <Image x:Name="image" Height="81" Width="78" Canvas.Left="40" Canvas.Top="136" Source="https://raw.githubusercontent.com/mseduvn/powershell/refs/heads/main/Files/images.png" HorizontalAlignment="Center" VerticalAlignment="Top" Visibility="Hidden"/>
        ...
        <Label x:Name="Link1" HorizontalAlignment="Left" Margin="262,420,0,0" VerticalAlignment="Top" Width="120" FontSize='10.5' ToolTip='vmware' FontFamily="Roboto" Padding="5,5,5,2">
